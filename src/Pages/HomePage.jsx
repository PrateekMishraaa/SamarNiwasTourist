...
const HomePage = () => {
  ...
  const images = [RoomOne, RoomTwo, RoomThree, Roomone];
  const services = [
    ...
    <>
      <div className="relative min-h-screen bg-gray-50">
        ...
        >
          ...
          >
              ...
              <div className='relative h-[80vh] w-full'>
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center bg-gradient-to-t from-black/70 via-black/50 to-black/30 text-white p-2 sm:p-4">
                  <div className="max-w-4xl text-center px-2 sm:px-4">
                    ...
                    >
                      <motion.p
                        className='text-sm sm:text-base cursor-pointer md:text-2xl lg:text-3xl font-light mb-2 sm:mb-6 max-w-2xl mx-auto font-bold font-serif text-red-500'
                        initial={{ scale: 0.8 }}
                        animate={{ scale: 1 }}
                        transition={{ duration: 0.5, delay: 0.8 }}
                      >
                        Limited time offer: Book your dream vacation today and save up to 30%. Best Hotels in Dehradun
                      </motion.p>
                    </motion.div>
                    <motion.button
            ...
            <div className='relative h-[80vh] w-full bg-red-200'>
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center bg-gradient-to-t from-black/70 via-black/50 to-black/30 text-white p-2 sm:p-4">
                <motion.div
                  className="max-w-4xl text-center px-3 sm:px-6 py-4 cursor-pointer hover:bg-green-400 hover:text-red-500 transition sm:py-10 bg-gradient-to-b from-white to-gray-100 rounded-2xl sm:rounded-3xl shadow-lg bg-opacity-60 w-[90%] sm:w-auto"
            ...
            <div className='relative h-[80vh] w-full'>
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center bg-gradient-to-t from-black/70 via-black/50 to-black/30 text-white p-2 sm:p-4">
                ...
                >
                  ...
                  {/* Heading */}
                  <motion.h1
                    className="text-xl sm:text-3xl md:text-4xl cursor-pointer lg:text-5xl font-bold text-gray-800 mb-2 sm:mb-4 drop-shadow-md text-red-500"
        ...
        <div className='min-h-[70vh]  w-full flex flex-col md:flex-row justify-between px-4 sm:px-6 md:px-10 py-6 sm:py-8 md:py-10 gap-4 sm:gap-6 md:gap-8'>
          <motion.div
            className='h-auto md:h-[60%] w-full md:w-[54%] bg-gray-900 text-white rounded-xl p-3 sm:p-4 md:p-6 order-2 md:order-1'
            variants={fadeInLeft}
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              It is surrounded by tall pine & oak trees, the hotel gives you a true feel of a vacation in hill station. The hotel caters exclusively to the taste of a traveler seeking the serine beauty in the Himalayan foothill. It's a preferred accommodation of every traveler visiting Nainital for its natural beauty.Five star hotel in dehradun The ambience and customer service has been specially designed to suit the tastes and requirements of budget mind leisure travelers with great hospitality.
            </motion.p>
          </motion.div>
          <motion.div
        ...
        <div className="w-full flex flex-col items-center px-4">
          <motion.div
            className="h-[20vh] w-full border-1 flex items-center justify-center rounded-2xl"
            variants={scaleUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
